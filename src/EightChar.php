...
class EightChar
{
    ...
    private function getZiZuo($zhiIndex, $gan, $ganIndex)
    {
        $index = self::$CHANG_SHENG_OFFSET[$gan] + ($ganIndex % 2 == 0 ? $zhiIndex : 0 - $zhiIndex);
        if ($index >= 12) {
            $index -= 12;
        }
        if ($index < 0) {
     ...
     * @return mixed|string
     */
    public function getYearZiZuo()
    {
        return $this->getZiZuo($this->lunar->getYearZhiIndexExact(), $this->getYearGan(), $this->lunar->getYearGanIndexExact());
    }
     ...
     * @return mixed|string
     */
    public function getMonthZiZuo()
    {
        return $this->getZiZuo($this->lunar->getMonthZhiIndexExact(), $this->getMonthGan(), $this->lunar->getMonthGanIndexExact());
    }
     ...
     * @return mixed|string
     */
    public function getDayZiZuo()
    {
        return $this->getZiZuo($this->lunar->getDayZhiIndex(), $this->getDayGan(), $this->getDayGanIndex());
    }
     ...
     * @return mixed|string
     */
    public function getTimeZiZuo()
    {
        return $this->getZiZuo($this->lunar->getTimeZhiIndex(), $this->getTimeGan(), $this->lunar->getTimeGanIndex());
    }
